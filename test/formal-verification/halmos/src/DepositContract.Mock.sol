/// @dev This is a copy of the Beacon Deposit contract at https://etherscan.io/address/0x00000000219ab540356cBB839Cbe05303d7705Fa#code
/// @dev We need it this way, because we can't deploy it with `create` from the bytecode with Halmos.
/// @dev Only changes are:
/// - The pragma version
/// - The interface used (for easier deployment)
/// - The constructor is actually commented out, because it makes deployment fail with Halmos...
/// ... which doesn't really matter as it is not the contract we are testing.
...
import {IDepositContract, ERC165} from "src/interfaces/IDepositContract.sol";
...
contract DepositContractMock is IDepositContract, ERC165 {
